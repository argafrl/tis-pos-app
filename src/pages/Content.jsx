        ...
        <div className="alert shadow-sm mt-2 bg-white border font-interBold max-w-7xl mx-auto rounded-xl prose">
          <div className="flex flex-col justify-start items-start">
            <div className="flex gap-2 items-center">
              ...
              <h3 className="m-0 font-interRegular">Welcome to The Island Shop</h3>
            </div>
            <p className="m-0 p-0 font-interRegular">Tropical-inspired retail store offering unique clothing, accessories, home decor, and souvenirs.</p>
          </div>
        </div>
